...
class UI:
    ...
    def print_menu():
        ...
        print("[21] Find the strongly-connected components")
        print("[0] Exit\n")
        ...
        while True:
            try:
                ...
                if user_option == '1':
                    ...
                    self.strongly_connected_components_ui()
                elif user_option == '0':
                    print("Exiting...")
                    break
                else:
